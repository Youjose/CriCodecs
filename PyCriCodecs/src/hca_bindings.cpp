...
void bind_hca_module(nb::module_& module) {
    ...
    nb::class_<cricodecs::hca::HcaCodecChunk>(module, "HcaCodecChunk")
        ...
        .def("uses_ms_stereo", &cricodecs::hca::HcaCodecChunk::uses_ms_stereo);
    ...
    nb::class_<cricodecs::hca::HcaVbrChunk>(module, "HcaVbrChunk")
        ...
        .def("enabled", &cricodecs::hca::HcaVbrChunk::enabled);

    nb::class_<cricodecs::hca::HcaAthChunk>(module, "HcaAthChunk")
        .def_ro("type", &cricodecs::hca::HcaAthChunk::type)
        .def("uses_curve", &cricodecs::hca::HcaAthChunk::uses_curve);
    ...
    nb::class_<cricodecs::hca::Hca>(module, "Hca")
        ...
        .def_prop_ro(
            ...
            [](const cricodecs::hca::Hca& hca) {
                return hca.source_path().empty() ? std::string() : hca.source_path().string();
            }
        )
        .def(
            "header",
        ...
        .def(
            "rebuild",
            [](const cricodecs::hca::Hca& hca) {
                return to_python_bytes(hca.rebuild());
            },
    ...
    install_attr_repr(module, "HcaEncodeConfig", {"sample_rate", "channel_count", "version", "bitrate", "quality", "loop_enabled", "loop_start", "loop_end", "keycode", "subkey"});
